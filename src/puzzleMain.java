...
public class puzzleMain extends javax.swing.JFrame{
    ...
    public puzzleMain() {
        try{
            ...
            ImageIcon ii=new ImageIcon(getClass().getResource("imagenes/layout/bard.gif"));
            Icon icono=new ImageIcon(ii.getImage().getScaledInstance(this.getWidth(),this.getHeight(),Image.SCALE_DEFAULT));
            
            sonido=java.applet.Applet.newAudioClip(getClass().getResource("audios/butchersbridge_champselect.wav"));
            sonido.play();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(697, 74, -1, -1));
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(765, 74, 99, 14));

        jLabel3.setText("Jugadas Rival");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(697, 94, -1, -1));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(769, 94, 95, 14));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(697, 114, 202, 17));

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(697, 137, 212, 408));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(697, 552, 143, -1));
        ...
        getContentPane().add(jButton17, new org.netbeans.lib.awtextra.AbsoluteConstraints(846, 551, -1, -1));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(169, 74, -1, -1));
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1100, 680));
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        enviarMensaje(mensaje,this.posJugador);
    ...
    public void enviarMensaje(String mensaje,int pos){
        cliente.enviarMensaje(mensaje, posJugador);
    }
    void setTexto(String mensaje, String mensaje0) {
        texto=texto+"Jugador"+mensaje0+":"+mensaje+"\n";
